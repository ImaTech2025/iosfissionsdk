//
//  FeedSmallBannerAdDemoViewController.m
//  FSUnionAdSDK-OCDemo
//
//  Created by 吴启晗 on 2025/8/26.
//

#import "FeedSmallBannerAdDemoViewController.h"
...
@interface FeedSmallBannerAdDemoViewController ()<UITableViewDataSource,UITableViewDelegate, FSNativeExpressFeedsAdDelegate>
{
    NSUInteger _adIndex;
    BOOL _loadSuccess;
}
...
@implementation FeedSmallBannerAdDemoViewController
...
- (UITableViewCell *)adCell {
    if (!_adCell) {
        _adCell = [[UITableViewCell alloc] init];
